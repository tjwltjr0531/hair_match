//#region node_modules/@mediapipe/face_mesh/face_mesh.js
(function() {
	"use strict";
	var v;
	function aa(a) {
	...
	J("Promise", function(a) {
		...
		b.prototype.B = function() {
			...
			"function" === typeof f ? f = new f("unhandledrejection", { cancelable: !0 }) : "function" === typeof h ? f = new h("unhandledrejection", { cancelable: !0 }) : (f = G.document.createEvent("CustomEvent"), f.initCustomEvent("unhandledrejection", !1, !0, f));
			f.promise = this;
			f.reason = this.i;
			return k(f);
		};
	...
	function Wb() {
		return Z(this, function b() {
			return O(b, function(c) {
				switch (c.g) {
					case 1: return c.m = 2, N(c, WebAssembly.instantiate(Sb), 4);
					case 4:
						c.g = 3;
						c.m = 0;
						break;
			...
			return O(d, function(y) {
				switch (y.g) {
					case 1:
						...
						return N(y, e.C, 2);
					case 2: return N(y, e.initialize(), 3);
					case 3:
