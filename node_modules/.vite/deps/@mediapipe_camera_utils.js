//#region node_modules/@mediapipe/camera_utils/camera_utils.js
(function() {
	"use strict";
	function n(a) {
		var b = 0;
	...
	v("Promise", function(a) {
		...
		b.prototype.A = function(c) {
			if (c === this) this.l(/* @__PURE__ */ new TypeError("A Promise cannot resolve to itself"));
			...
			function g() {
				switch (k.h) {
					...
					case 2:
						d(k.i);
						break;
					default: throw Error("Unexpected state: " + k.h);
				}
			}
			var k = this;
	...
	N.prototype.start = function() {
		...
		return J(new I(new B(function(e) {
			...
			b = a.h;
			return e.return(navigator.mediaDevices.getUserMedia({ video: {
